...
export const SocketProvider = ({ children }) => {
    const { userDetails, setFriendRequests, setFriendsRequestsCount, setFriends, setFriendsCount, setRequestedFriends, setRequestedFriendsCount } = useUser();
    ...
    useEffect(() => {
        ...
        // Event listener for friend request notification
